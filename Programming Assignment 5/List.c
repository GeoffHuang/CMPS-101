...
// Note: I added a helper function - void sortedInsert(List L, int v)
// ============================================================================
...
// inserts an integer v into a List L so that L is in ascending numerical order
// used in Graph.c functions: addEdge(), addArc(), and transpose()
void sortedInsert(List L, int v)
{
	if (L == NULL)
	{
		printf("List Error: calling sortedInsert() on NULL List reference\n");
		exit(1);
	}
